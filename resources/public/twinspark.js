...
(function(window, document, tsname) {
  ...
  var FUNCS = {
    ...
    template: function(strategy, templateSel, o) {
      var templateEl = findTarget(o.el, templateSel);
      var html = new DOMParser().parseFromString(templateEl.innerHTML, 'text/html');
      var reply = findReply(o.el, o.event.target, html.body);
      var resEls = executeSwap(strategy, o.el, reply);
      activate.apply(null, resEls);
      return resEls;
    }
  };
